        ...
        <div class="card shadow  text-white bg-dark">
            ...
            <div class="card-body">
                <div class="btn-group w-100 mb-3" role="group" aria-label="Basic radio toggle button group">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <input type="radio"
                                class="btn-check nav-link"data-bs-toggle="pill"aria-controls="send-request"
                                data-bs-target="#send-request" name="btnradio" role="tab" id="btnradio1"
                                autocomplete="off" checked>
                            <label class="btn btn-outline-primary" for="btnradio1" id="get_suggestions_btn">Suggestions
                                ({{ $usersData->count() }})</label>
                        </li>

                        <li class="nav-item" role="presentation">
                            <input type="radio" class="btn-check nav-link"data-bs-toggle="pill"
                                data-bs-target="#pills-home" name="btnradio"role="tab" id="btnradio2"
                                autocomplete="off">
                        ...
                        <li class="nav-item" role="presentation">
                            <input type="radio" class="btn-check nav-link"data-bs-toggle="pill"role="tab"
                                data-bs-target="#pills-home" name="btnradio" id="btnradio3" autocomplete="off">
                        ...
                        <li class="nav-item" role="presentation">
                            <input type="radio" class="btn-check nav-link"data-bs-toggle="pill"role="tab"
                                data-bs-target="#pills-home" name="btnradio" id="btnradio4" autocomplete="off">
                ...
                <div id="send-request">
                    ...
                    <x-request :usersData="$usersData" :mode="'sent'" />
                </div>
                <span class="fw-bold">Received Request Blade</span>
                <x-request :usersData="$usersData" :mode="'received'" />

                <span class="fw-bold">Suggestion Blade</span>
                <x-suggestion :usersData="$usersData" />
